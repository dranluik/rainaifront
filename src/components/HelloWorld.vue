...
<script>
import RainContactView from "@/components/RainContactView.vue";

export default {
  name: 'HelloWorld',
  components: {RainContactView},
  props: {
    msg: String
  }
}
...
<style>
.custom-background {
  background-color: #1e1ee3; /* Replace with your desired background color */
}
